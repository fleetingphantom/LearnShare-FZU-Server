...
type Resource struct {
	...
	ResourceName  string `thrift:"resourceName,2,required" form:"resourceName,required" json:"resourceName,required" query:"resourceName,required"`
	...
	ResourceUrl   string `thrift:"resourceUrl,4,required" form:"resourceUrl,required" json:"resourceUrl,required" query:"resourceUrl,required"`
	...
	AverageRating int64  `thrift:"averageRating,10,required" form:"averageRating,required" json:"averageRating,required" query:"averageRating,required"`
	...
	Status        string `thrift:"status,12,required" form:"status,required" json:"status,required" query:"status,required"`
...
func (p *Resource) GetResourceName() (v string) {
...
func (p *Resource) GetResourceUrl() (v string) {
	return p.ResourceUrl
}

func (p *Resource) GetType() (v string) {
	return p.Type
}

func (p *Resource) GetSize() (v int64) {
	return p.Size
}
...
func (p *Resource) GetAverageRating() (v int64) {
...
func (p *Resource) GetStatus() (v string) {
	return p.Status
}
...
func (p *Resource) Read(iprot thrift.TProtocol) (err error) {
	...
	var issetDescription bool = false
	var issetResourceUrl bool = false
...
func (p *Resource) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("resourceName", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *Resource) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("resourceUrl", thrift.STRING, 4); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *Resource) writeField10(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("averageRating", thrift.I64, 10); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI64(p.AverageRating); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
