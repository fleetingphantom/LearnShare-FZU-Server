...
type SearchResp struct {
	...
	Courses      []*module.Course `thrift:"courses,2,optional" form:"courses" json:"courses,omitempty" query:"courses"`
}
...
type GetCourseResourceListResp struct {
	BaseResponse *module.BaseResp   `thrift:"baseResponse,1,required" form:"baseResponse,required" json:"baseResponse,required" query:"baseResponse,required"`
	Resources    []*module.Resource `thrift:"resources,2,optional" form:"resources" json:"resources,omitempty" query:"resources"`
}
...
type GetCourseCommentsResp struct {
	BaseResponse *module.BaseResp        `thrift:"baseResponse,1,required" form:"baseResponse,required" json:"baseResponse,required" query:"baseResponse,required"`
	Comments     []*module.CourseComment `thrift:"comments,2,optional" form:"comments" json:"comments,omitempty" query:"comments"`
}
